<template>
  ...
  >
    <div class="text-center my-3">
      <v-chip class="mx-4 mb-3 rounded-chip text-caption" draggable variant="tonel" color="black" size="" rounded="circle" text="Relevância para a dor" @dragstart="dragStart" @dragover.prevent @drop="dropChip"></v-chip>
      <v-chip class="mx-4 mb-3 rounded-chip text-caption" draggable variant="tonel" color="black" size="" rounded="circle">Facilidade de coleta</v-chip>
      <v-chip class="mx-4 mb-3 rounded-chip text-caption" draggable variant="tonel" color="black" size="" rounded="circle">Preferência pessoal</v-chip>
    </div>
